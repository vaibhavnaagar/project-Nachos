...
class CoreMap {
  public:
    bool IsEmpty = TRUE;         // Bit is set if the physical page is free.
      //ProcessAddrSpace* addrSpace = NULL; //Pointer to the address space of the process using the page

    int virtPage ; //The virtual page number mapped to this physical page
