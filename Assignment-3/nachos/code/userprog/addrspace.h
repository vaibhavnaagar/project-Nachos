...
class ProcessAddrSpace {
  public:
    ...
    ProcessAddrSpace(ProcessAddrSpace *parentSpace, int sharedPages, unsigned *vaddr);  //Used for sharing memory
    ...
    void FreePages(int pid);

    int replacePage(int ign);
    void access(int pageFrame);
