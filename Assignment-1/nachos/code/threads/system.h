...
extern int PID_count;  //count maximum pid assigned yet
extern int numActiveProcesses;  //Tracks number of active processes(sleeping + ready +executing) 
extern int MaxPage;	//Counts number of pages used so far
extern bool MemoryFull; 	// Indicates if memory is full
