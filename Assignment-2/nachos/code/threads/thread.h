...
class NachOSThread {
  ...
  //  void SetstartTime(unsigned t);

    unsigned GetprevstartTime();
    void SetprevstartTime(unsigned t);

    unsigned GettotalCPUburst();

    unsigned GetmaxCPUburst();

    unsigned GetminCPUburst();

    unsigned GetsleepTime();
   // void SetsleepTime(unsigned t);

    unsigned GetsleepstartTime();
    //void SetsleepstartTime(unsigned t);

    unsigned GetnumCPUburst();
  ...
  private:
    ...
    unsigned prevstartTime;
    unsigned totalCPUburst = 0;
    unsigned maxCPUburst = 0;
    unsigned minCPUburst = 0;
    unsigned numCPUburst = 0;

    unsigned sleepTime = 0;
    unsigned sleepstartTime = 0;
