...
int schedAlgo;
bool doYield;
unsigned threadPriority[MAX_THREAD_COUNT];
unsigned threadBasePriority[MAX_THREAD_COUNT];
unsigned threadCpuCount[MAX_THREAD_COUNT];
unsigned burstPredict[MAX_THREAD_COUNT];
unsigned prevBurst[MAX_THREAD_COUNT];
...
Initialize(int argc, char **argv)
{
    ...
    /*  Comment this switch case when timerticks is also provided in the batch file
    to set the given quanta */

    switch(schedAlgo)
    {
      case 3: TimerTicks = Quanta_1;                        // Round Robin - Quanta_1 =31
              break;
      case 4: TimerTicks = Quanta_2;                        // Round Robin - Quanta_2 =62
	      break;
      case 5: TimerTicks = Quanta_3;                        // Round Robin - Quanta_3 =93
              break;
      case 6: TimerTicks = Quanta_4;                        // Round Robin - Quanta_4 =20
              break;
      case 7: TimerTicks = Quanta_1;                        // Unix scheduler - Quanta_1 =31
              break;
      case 8: TimerTicks = Quanta_2;                        // Unix scheduler - Quanta_2 =62
              break;
      case 9: TimerTicks = Quanta_3;                        // Unix scheduler - Quanta_3 =93
              break;
      case 10: TimerTicks = Quanta_4;                       // Unix scheduler - Quanta_4=20
              break;
      default: TimerTicks = DefaultQuanta;                  // Other Algos (Non-preemptive) Quanta=100
              break;
    ...
    for (i=0; i<MAX_THREAD_COUNT; i++)
    {
       ...
       threadPriority[i] = 0;
       threadBasePriority[i] = 0;
       threadCpuCount[i] = 0;
       burstPredict[i] = INIT_GUESS;
       prevBurst[i] = 0;
    }
    thread_index = 0;
