...
class Statistics {
  public:
    ...
    int numPacketsRecvd;	// number of packets received over the network
     ...
     unsigned TotalCPUbusytime ;
     unsigned Totalexecutiontime;
     unsigned MaximumBurstLength ;
     unsigned MinimumBurstLength ;
     unsigned NumBursts;
     unsigned NumProcesses;
     unsigned MaximumExecutionTime ;
     unsigned MinimumExecutionTime ;
     unsigned TotalWaittime;
     unsigned ThreadExecutionArray[1000];
     unsigned EstimationError;
...
#define DefaultQuanta 100   // (average) time between timer interrupts
